(function(){
  ...
  var G = {
    ...
    spd:{y:50, h:40, tiers:[
      {n:1, x:141, w:41, path:"M0,0 L27,0 L41,20 L27,40 L0,40 Z", point:{x:2, y:0, w:33, h:40, size:15}, grid:{}},
  ...
  function speedFrame(n){
    ...
    return {x:t.x, y:G.spd.y, w:t.w, h:G.spd.h, path:t.path, point:t.point, grid:t.grid, hdrX:t.x + t.w / 2 - G.hdr.w / 2};
  }
