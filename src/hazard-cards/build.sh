#!/usr/bin/env bash
# Builds the Hazard Cards tool from the parts in this folder.
#
#   ./src/hazard-cards/build.sh          → hazard-cards.html   (the site page: fonts.css + Toolbag nav)
