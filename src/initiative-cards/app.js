(function(){
  ...
  function arKindChanged(){
    ...
    var strike = k === "melee" || k === "ranged";
    $("arMod").placeholder = k === "spell" ? "DC 20" : strike ? "to hit +12" : k === "reaction" || k === "action" ? "(optional)" : "+12";
    $("arMod").setAttribute("aria-label", k === "spell" ? "Spell DC" : strike ? "Attack modifier (to hit)" : "Bonus");
    $("arMod").title = strike ? "The Strike's attack modifier: the bonus to hit" : "";
  }
